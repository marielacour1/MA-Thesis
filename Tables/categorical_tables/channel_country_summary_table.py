...
def parse_args() -> argparse.Namespace:
	...
	default_output = script_dir / "gl-cl-channel-country-summary-google-docs.html"

	parser = argparse.ArgumentParser(
		description="Save a Google Docs-ready table of platform-collected categorical variables."
	)
